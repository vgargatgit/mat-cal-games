...
export function HUD({ game, stars, progress, muted, onHome, onRestart, onTutorial, onHint, onMute }) {
  return el('header', { className: 'hud' },
    ...
    el('nav', { className: 'hud__actions', 'aria-label': 'Game controls' },
      ...
      Button('Rules', { icon: 'ⓘ', 'aria-label': `Open ${game.title} tutorial`, onclick: onTutorial }),
